...
mod tests {
    ...
    async fn test_mongodb_scan_insert(ctx: &mut AppTestContext) -> Result<(), AppError> {
    ...
    #[test(tokio::test)]
    #[ignore = "requires mongodb test server setup"]
    async fn test_mongodb_scan_latest(ctx: &mut AppTestContext) -> Result<(), AppError> {
        let mongodb = &ctx.state.mongodb;
    ...
    #[test(tokio::test)]
    #[ignore = "requires mongodb test server setup"]
    async fn test_mongodb_scan_mark_completed(ctx: &mut AppTestContext) -> Result<(), AppError> {
        let mongodb = &ctx.state.mongodb;
    ...
    #[test(tokio::test)]
    #[ignore = "requires mongodb test server setup"]
    async fn test_mongodb_scan_mark_failed(ctx: &mut AppTestContext) -> Result<(), AppError> {
        let mongodb = &ctx.state.mongodb;
    ...
    #[test(tokio::test)]
    #[ignore = "requires mongodb test server setup"]
    async fn test_mongodb_scan_start(ctx: &mut AppTestContext) -> Result<(), AppError> {
        let mongodb = &ctx.state.mongodb;
